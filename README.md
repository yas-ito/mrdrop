...
写真アプリの共有ボタンから送るだけ、を目指しています。クラウドを通りません。端末どうしで直接送ります。
...
| | |
|---|---|
| **iPhone アプリ**（送る側） | **App Store で無料** — <https://apps.apple.com/jp/app/id6808082392> |
| **パソコン側**（受け取る側・Windows / Mac） | **BOOTH で頒布しています** — <https://yas-tools.booth.pm/items/8832410> |

このリポジトリはソースです。**すぐ使える形（Node 同梱・説明書つき）が要る方は BOOTH の方をどうぞ。**
Windows 版は展開して `はじめる.bat` を押すだけ、Mac 版はメニューバー常駐のアプリです。
